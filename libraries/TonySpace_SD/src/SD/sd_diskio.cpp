 ...
 * SD SPI
 * */
 static uint8_t SD_cs_Sel;
void setSlot_(uint8_t slot)
{
	SD_cs_Sel = getPinIO[slot];
	Tony.pinMode(SD_cs_Sel,OUTPUT);
	Tony.digitalWrite(SD_cs_Sel,HIGH);
}
...
{
	Tony.digitalWrite(SD_cs_Sel,LOW);
    ardu_sdcard_t * card = s_cards[pdrv];
